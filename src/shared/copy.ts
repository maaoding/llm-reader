...
export const COPY_KEYS = [
  ...
  'settings.scaleChanged',
  'settings.readingTitle',
  'settings.restoreDefaults',
  'settings.readingRestored',
  'settings.fontLabel',
  'settings.fontAria',
  'settings.fontChanged',
  'settings.lineHeight',
  'settings.lineHeightUpdated',
  'settings.indent',
  'settings.indentUpdated',
...
export const COPY_PLACEHOLDERS = {
  ...
  'assistant.citationJumpTitle': ['passageId'],
  'settings.themeChanged': ['theme'],
  'settings.scaleChanged': ['scale'],
  'settings.fontChanged': ['scale'],
